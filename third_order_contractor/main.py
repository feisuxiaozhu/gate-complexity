...
N = sym.Symbol('N')
c_dagger_dict={'1':V_2_1+V_11_1,'2':V_2_1-V_11_1,'3':N/(N-1)/(N+1)*V_1-1/(N+1)*V_2_1-1/(N-1)*V_11_1,'4':N/(N-1)/(N+1)*V_1-1/(N+1)*V_2_1-1/(N-1)*V_11_1,'5':-V_1/(N-1)/(N+1)-1/(N+1)*V_2_1+1/(N-1)*V_11_1,'6':-V_1/(N-1)/(N+1)-1/(N+1)*V_2_1+1/(N-1)*V_11_1}
B_res={}
for item in temp6:
    D=[]
    for i in range(1,len(item)):
...
print(expr)
print('--------------------')
expr = (16*N**7*V_1**2*V_11_1**2 + 16*N**7*V_1**2*V_2_1**2 - 32*N**7*V_1*V_11_1**3 - 32*N**7*V_1*V_2_1**3 + 5*N**6*V_1**3*V_11_1 + 23*N**6*V_1**3*V_2_1 + N**6*V_1**2*V_11_1**2 - 121*N**6*V_1**2*V_2_1**2 - 28*N**6*V_1*V_11_1**3 + 8*N**6*V_1*V_11_1**2*V_2_1 - 8*N**6*V_1*V_11_1*V_2_1**2 + 236*N**6*V_1*V_2_1**3 + 12*N**6*V_11_1**4 - 4*N**6*V_11_1**3*V_2_1 + 4*N**6*V_11_1*V_2_1**3 - 172*N**6*V_2_1**4 + 8*N**5*V_1**4 + 18*N**5*V_1**3*V_11_1 - 80*N**5*V_1**3*V_2_1 - 110*N**5*V_1**2*V_11_1**2 - 26*N**5*V_1**2*V_11_1*V_2_1 + 260*N**5*V_1**2*V_2_1**2 + 178*N**5*V_1*V_11_1**3 + 6*N**5*V_1*V_11_1**2*V_2_1 + 46*N**5*V_1*V_11_1*V_2_1**2 - 430*N**5*V_1*V_2_1**3 - 27*N**5*V_11_1**4 - 4*N**5*V_11_1**3*V_2_1 - 2*N**5*V_11_1**2*V_2_1**2 - 28*N**5*V_11_1*V_2_1**3 + 333*N**5*V_2_1**4 - 12*N**4*V_1**4 + 5*N**4*V_1**3*V_11_1 + 47*N**4*V_1**3*V_2_1 - 147*N**4*V_1**2*V_11_1**2 + 46*N**4*V_1**2*V_11_1*V_2_1 - 67*N**4*V_1**2*V_2_1**2 + 331*N**4*V_1*V_11_1**3 - 29*N**4*V_1*V_11_1**2*V_2_1 - 59*N**4*V_1*V_11_1*V_2_1**2 - 3*N**4*V_1*V_2_1**3 - 173*N**4*V_11_1**4 + 14*N**4*V_11_1**3*V_2_1 + 42*N**4*V_11_1*V_2_1**3 + 85*N**4*V_2_1**4 - 12*N**3*V_1**4 + 6*N**3*V_1**3*V_11_1 + 110*N**3*V_1**3*V_2_1 - 17*N**3*V_1**2*V_11_1**2 + 22*N**3*V_1**2*V_11_1*V_2_1 - 397*N**3*V_1**2*V_2_1**2 + 102*N**3*V_1*V_11_1**3 - 30*N**3*V_1*V_11_1**2*V_2_1 - 14*N**3*V_1*V_11_1*V_2_1**2 + 694*N**3*V_1*V_2_1**3 - 182*N**3*V_11_1**4 + 20*N**3*V_11_1**3*V_2_1 + 4*N**3*V_11_1**2*V_2_1**2 + 4*N**3*V_11_1*V_2_1**3 - 518*N**3*V_2_1**4 + 22*N**2*V_1**4 + 20*N**2*V_1**3*V_11_1 - 164*N**2*V_1**3*V_2_1 + 54*N**2*V_1**2*V_11_1**2 - 44*N**2*V_1**2*V_11_1*V_2_1 + 470*N**2*V_1**2*V_2_1**2 - 152*N**2*V_1*V_11_1**3 + 16*N**2*V_1*V_11_1**2*V_2_1 + 64*N**2*V_1*V_11_1*V_2_1**2 - 632*N**2*V_1*V_2_1**3 + 42*N**2*V_11_1**4 - 4*N**2*V_11_1**3*V_2_1 - 44*N**2*V_11_1*V_2_1**3 + 294*N**2*V_2_1**4 - 12*N*V_1**4 + 8*N*V_1**3*V_11_1 + 66*N*V_1**3*V_2_1 + 15*N*V_1**2*V_11_1**2 + 4*N*V_1**2*V_11_1*V_2_1 - 167*N*V_1**2*V_2_1**2 - 120*N*V_1*V_11_1**3 + 24*N*V_1*V_11_1**2*V_2_1 - 32*N*V_1*V_11_1*V_2_1**2 + 152*N*V_1*V_2_1**3 + 145*N*V_11_1**4 - 16*N*V_11_1**3*V_2_1 - 2*N*V_11_1**2*V_2_1**2 + 24*N*V_11_1*V_2_1**3 - 7*N*V_2_1**4 - 2*V_1**4 + 2*V_1**3*V_11_1 - 2*V_1**3*V_2_1 - 4*V_1**2*V_11_1**2 - 2*V_1**2*V_11_1*V_2_1 + 6*V_1**2*V_2_1**2 - 23*V_1*V_11_1**3 + 5*V_1*V_11_1**2*V_2_1 + 3*V_1*V_11_1*V_2_1**2 + 15*V_1*V_2_1**3 + 55*V_11_1**4 - 6*V_11_1**3*V_2_1 - 2*V_11_1*V_2_1**3 - 15*V_2_1**4)/(N**7 + N**6 - 3*N**5 - 3*N**4 + 3*N**3 + 3*N**2 - N - 1)
