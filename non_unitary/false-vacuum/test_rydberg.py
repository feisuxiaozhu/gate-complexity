...
full_rho_tilde = [create_spin_state(N,[2,4])]
i=0
for rho_tilde in full_rho_tilde:
    i+=1
    print(i)
    E_final, rho_tilde = driver(rho_tilde,H_tilde,two_qubit_set_tilde,ancilla_two_qubit_set_tilde ,dt,100)
...
# rho_tilde = create_spin_state(N,[1,5])
# fig, axes = plt.subplots(1, 2, figsize=(16, 5))
# steps = 100
# rho_tilde_SGD = rho_tilde.copy()
# rho_tilde_ancilla = rho_tilde.copy()
