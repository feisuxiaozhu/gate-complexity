...
C6 = 1*10**4
r0 = 8.13
Delta_glob = 1/4*np.pi * 5.0  
Delta_loc =  1/32*np.pi *10
...
print(list(itertools.product([0, 1], repeat=N))[18])
rho_tilde = 1/2*create_spin_state(N,[0,2,4])+1/2*create_spin_state(N,[1,3,5])
